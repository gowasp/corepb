...
func init() {
	proto.RegisterType((*Publish)(nil), "corepb.Publish")
}
...
var fileDescriptor_34180b7635741fb2 = []byte{
	...
	0xc9, 0x2c, 0xce, 0xd0, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0x62, 0x4b, 0xce, 0x2f, 0x4a, 0x2d,
	0x48, 0x52, 0x32, 0xe6, 0x62, 0x0f, 0x80, 0x48, 0x08, 0x89, 0x70, 0xb1, 0x96, 0xe4, 0x17, 0x64,
	0x26, 0x4b, 0x30, 0x2a, 0x30, 0x6a, 0x70, 0x06, 0x41, 0x38, 0x42, 0x42, 0x5c, 0x2c, 0x49, 0xf9,
	0x29, 0x95, 0x12, 0x4c, 0x0a, 0x8c, 0x1a, 0x3c, 0x41, 0x60, 0xb6, 0x93, 0xc2, 0x89, 0x47, 0x72,
	0x8c, 0x17, 0x1e, 0xc9, 0x31, 0x3e, 0x78, 0x24, 0xc7, 0x38, 0xe1, 0xb1, 0x1c, 0xc3, 0x85, 0xc7,
	0x72, 0x0c, 0x37, 0x1e, 0xcb, 0x31, 0x44, 0x41, 0x8d, 0x4d, 0x62, 0x03, 0xdb, 0x62, 0x0c, 0x08,
	0x00, 0x00, 0xff, 0xff, 0xd8, 0x61, 0xb3, 0x8b, 0x76, 0x00, 0x00, 0x00,
}
...
func (m *Publish) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Body) > 0 {
		i -= len(m.Body)
		copy(dAtA[i:], m.Body)
		i = encodeVarintPublish(dAtA, i, uint64(len(m.Body)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Topic) > 0 {
